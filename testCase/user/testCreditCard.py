...
acceptPayment_xls = ExcelReader().get_xls(None, "creditCard")
    ...
    def checkResult(self):
        ...
        if (self.return_json.status_code == 200):
            if (self.info['rc'] == '0'):
                ...
                apiTester = ApiTester()
                self.return_json = apiTester.send_3d_auth_command(self.info['redirect_data']['strRqXML'])
                apiTester.send_receive_3d_command(self.return_json.text)  # 呼叫confirmtrans
